...
generation-history-parameter-ledger の作業手順です。
...
- asset は `dist/generation-history-parameter-ledger-docs.zip`、`docs/manual-test.md`、`docs/strict-manual-test-addendum.md`。
